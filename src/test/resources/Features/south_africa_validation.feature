Feature: Validate South Africa's JSON Schema
  ...
  Scenario: Validate the schema for South Africa response
    Given the api endpoint is "https://restcountries.com/v3.1/name/south%20africa?fullText=true"
    When I make a GET request to "https://restcountries.com/v3.1/name/south%20africa?fullText=true"
